...
export function StatsCard({ icon: Icon, title, value, trend, color }: StatsCardProps) {
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br ${color} p-3 sm:p-6 shadow-lg shadow-black/20 smooth-transition hover:shadow-xl hover:shadow-black/40 border border-white/10`}
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-2 sm:mb-4">
          <div className="p-1.5 sm:p-2 bg-black/20 rounded-lg backdrop-blur-sm shrink-0">
        ...
        <div className="flex items-end justify-between gap-1">
          ...
          {trend !== undefined && (
            <div className="flex flex-col items-end shrink-0">
              <div
                className={`flex items-center gap-0.5 text-[10px] sm:text-xs font-semibold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md backdrop-blur-sm ${
