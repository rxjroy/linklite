        ...
        <div className="backdrop-blur-xl bg-black/40 border border-white/10 shadow-2xl rounded-3xl p-8">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              ...
              <span className="text-[#0000FF] font-medium">{maskedEmail}</span>
            </p>
          </div>
          ...
          <div className="flex justify-center gap-3 mb-8">
            {otp.map((digit, index) => (
              <input
                ...
                disabled={loading}
                className="w-12 h-14 text-center text-xl font-bold bg-secondary/30 border border-white/10 rounded-xl text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0000FF]/50 focus:border-[#0000FF]/50 transition-all duration-300 disabled:opacity-50"
                autoFocus={index === 0}
              />
            ))}
          </div>
          ...
          <NeonButton
            ...
            className="w-full h-12 gap-2 font-medium bg-[#0000FF] hover:bg-[#0000DD] text-white rounded-xl shadow-[0_0_20px_rgba(0,0,255,0.3)] hover:shadow-[0_0_30px_rgba(0,0,255,0.5)] transition-all mb-6"
          >
            {loading ? (
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-sm font-medium text-[#0000FF] hover:text-[#0000DD] disabled:text-gray-600 disabled:cursor-not-allowed transition-colors"
            >
